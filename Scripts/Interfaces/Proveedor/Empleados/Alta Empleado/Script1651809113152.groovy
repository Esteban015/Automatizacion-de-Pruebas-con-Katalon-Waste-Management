...
WebUI.setText(findTestObject('Object Repository/Page_Empleados/input_email_form-control'), 'vwindler@example.org')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_Empleados/input_lock_outline_form-control'), '373N5QL8KVQ=')
