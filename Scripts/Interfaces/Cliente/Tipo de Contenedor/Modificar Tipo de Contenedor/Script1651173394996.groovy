...
WebUI.setText(findTestObject('Object Repository/Page_Tipo_de_Contenedor/input_email_form-control (1)'), 'cborer@example.org')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_Tipo_de_Contenedor/input_lock_outline_form-control (1)'), 
    '373N5QL8KVQ=')
