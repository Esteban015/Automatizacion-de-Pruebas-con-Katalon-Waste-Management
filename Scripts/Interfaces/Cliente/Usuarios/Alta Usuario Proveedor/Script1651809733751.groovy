...
WebUI.setText(findTestObject('Object Repository/Page_Usuarios_Proveedor/input_email_form-control'), 'cborer@example.org')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_Usuarios_Proveedor/input_lock_outline_form-control'), '373N5QL8KVQ=')
